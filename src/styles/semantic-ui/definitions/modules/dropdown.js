        ...
        module = {
          ...
          filterItems(query) {
            const
              searchTerm = (query !== undefined)
                ...
                : module.get.query();
            let results = null;
            const escapedTerm = module.escape.regExp(searchTerm);
              ...
              $item
                .each(function () {
                  ...
                  if (settings.match == 'both' || settings.match == 'text') {
                    ...
                    if (settings.fullTextSearch && module.fuzzySearch(searchTerm, text)) {
                      results.push(this);
                      return true;
                    }
                  }
                  if (settings.match == 'both' || settings.match == 'value') {
                    ...
                    if (settings.fullTextSearch && module.fuzzySearch(searchTerm, value)) {
                      results.push(this);
                      return true;
                    }
                  }
          ...
          forceSelection() {
            ...
            const $selectedItem = ($currentlySelected.length > 0)
              ? $currentlySelected
              : $activeItem;
            const hasSelected = ($selectedItem.size() > 0);
            if (module.has.query()) {
              if (hasSelected) {
          ...
          event: {
            ...
            item: {
              mouseenter(event) {
                ...
                const $otherMenus = $(this).siblings(selector.item).children(selector.menu);
                if ($subMenu.length > 0) {
          ...
          set: {
            filtered() {
              ...
              const searchWidth = module.get.searchWidth(searchValue.length);
            ...
            value(value, text, $selected) {
              ...
              const isAddition = !module.has.value(value);
          ...
          remove: {
            ...
            label(value, shouldAnimate) {
              ...
              const $removedLabel = $labels.filter(`[data-value="${value}"]`);
